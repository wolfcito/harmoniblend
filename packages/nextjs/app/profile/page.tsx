        ...
        <div className="container py-8 mx-auto">
          <div className="grid grid-cols-4 gap-6 px-4 sm:grid-cols-12">
            <div className="col-span-4 sm:col-span-3">
              <div className="p-6 border rounded-lg shadow border-lime-300">
                <div className="flex flex-col items-center">
                  ...
                  <div className="flex flex-wrap justify-center gap-4 mt-6">
                    <a
                      href="#"
                      className="px-4 py-2 text-white border rounded-full border-limelight hover:shadowmd hover:shadow-limelight"
                    >
                      Create Profile
                    </a>
                  </div>
                ...
                <div className="flex flex-col">
                  <span className="mb-2 font-bold tracking-wider text-gray-700 uppercase">Projects</span>
                  <ul>
                    <li className="mb-2">Saving the World</li>
                    <li className="mb-2">Harmoniblend</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="col-span-4 sm:col-span-9">
              <div className="p-6 border rounded-lg shadow border-lime-300">
                ...
                <h3 className="mt-3 -mb-2 font-semibold text-center">Find me on</h3>
                ...
                <h2 className="mt-6 mb-4 text-xl font-bold">Past Projects</h2>
                <div className="mb-6">
                  <div className="flex flex-wrap justify-between w-full gap-2">
                    <span className="font-bold text-gray-700">Web Developer</span>
                    <p>
                      <span className="mr-2 text-gray-700">at Allo Hackathon</span>
                      <span className="text-gray-700">2017 - 2019</span>
                    </p>
                  </div>
                  <p className="mt-2">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed finibus est vitae tortor ullamcorper,
                    ut vestibulum velit convallis. Aenean posuere risus non velit egestas suscipit.
                  </p>
                </div>
                <div className="py-6 sm:grid sm:grid-cols-3 sm:gap-4">
                  <dt className="text-sm font-medium leading-6">Documents</dt>
                  <dd className="mt-2 text-sm sm:col-span-2 sm:mt-0">
                    <ul role="list" className="border border-gray-200 divide-y divide-gray-700 rounded-md">
                      <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                        <div className="flex items-center flex-1 w-0">
                          <div className="flex flex-1 min-w-0 gap-2 ml-4">
                            <span className="font-medium truncate">Interview_Audio_Log.wav.pdf</span>
                      ...
                      <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                        <div className="flex items-center flex-1 w-0">
                          <div className="flex flex-1 min-w-0 gap-2 ml-4">
                            <span className="font-medium truncate">Forensic_Analysis_Report.pdf</span>
