    ...
    <div>
      <div className="p-6 md:p-14">
        <div className="flex flex-row justify-between">
          ...
          <Link
            href="/newjar"
            className="px-4 py-2 border rounded-full border-limelight hover:shadow-md hover:shadow-lime-600"
          >
            New Pool
          </Link>
        </div>
        <div className="mt-6 sm:grid sm:grid-cols-3 sm:gap-6">
          {pools.map((pool, index) => (
            <div
              key={index}
              className="col-span-2 mb-3 overflow-hidden border rounded-2xl border-limelight md:col-span-1"
            >
