    ...
    <div className="py-24 sm:py-32">
      <div className="px-6 mx-auto text-center max-w-7xl lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-lg leading-8 text-gray-400">We’re passionate about what we do.</p>
        </div>
        <ul
          role="list"
        ...
        >
          {TEAM.map(person => (
            <li key={person.name} className="px-8 py-10 border rounded-2xl border-limelight">
              <Image
                height={48}
                width={48}
