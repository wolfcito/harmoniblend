import { ProjectCollection } from '~~/types/projects-funded.type'
...
export const PROJECTS: ProjectCollection = {
  ...
  '3': {
    ...
    'short-description': 'Trees help us breathe, and live',
    description:
  ...
  '4': {
    ...
    'short-description': 'Many people are in need of food, you waste food on restaurants. Why not donate this?',
    description:
  ...
  '5': {
    ...
    'short-description': 'Round and round goes your wheelchair, your path to get everything done, should be a right',
    description:
